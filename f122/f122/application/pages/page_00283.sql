...
,p_last_upd_yyyymmddhh24miss=>'20241227163913'
);
...
,p_ajax_items_to_submit=>'P283_COD_PROVEEDOR,P283_TIPO_VALE,P283_FEC_RECEPCIONP283_FECHA_VENCIMIENTO,P_COD_EMPRESA'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(390607471896583031)
,p_plug_name=>'Entrega Masiva de Vales'
,p_parent_plug_id=>wwv_flow_imp.id(133810733383222838)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(390607849242583035)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(390607471896583031)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(390607570742583032)
,p_name=>'P283_NRO_DESDE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(390607471896583031)
,p_prompt=>'Nro Desde'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(390607632777583033)
,p_name=>'P283_NRO_HASTA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(390607471896583031)
,p_prompt=>'Nro Hasta'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(390607768912583034)
,p_name=>'P283_VENDEDOR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(390607471896583031)
,p_prompt=>'Vendedor'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_VENDEDORES_PUN_ FVENTVAL'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(390607964956583036)
,p_name=>'P283_TIPO_VALE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(390607471896583031)
,p_prompt=>'Tipo Vale'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(390608101612583038)
,p_name=>'P283_PROVEEDOR_VALE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(390607471896583031)
,p_prompt=>'Proveedor Vale'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select p.nombre, pro.cod_proveedor ',
'from fv_REGISTRO_vales_combustibles f, cm_proveedores pro, personas p',
'where f.cod_empresa=:p_cod_empresa',
'and f.cod_proveedor=pro.cod_proveedor',
'and f.cod_empresa=pro.cod_empresa',
'and pro.cod_persona=p.cod_persona',
'group by  p.nombre, pro.cod_proveedor '))
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(390608274416583039)
,p_name=>'da_asigna_vale'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(390607849242583035)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608820185583045)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if :P283_TIPO_VALE is null then',
'     raise_application_error(-20001,''Es Obligatorio el TIPO DE VALE''   ) ;',
'    end if;',
'   ',
'',
'if :P283_PROVEEDOR_VALE is null then',
'',
'       raise_application_error(-20001,''Es Obligatorio EL PROVEEDOR DEL VALE ''   ) ;',
'    end if;',
'',
'    if :P283_NRO_DESDE is null then',
'      raise_application_error(-20001,''Es Obligatorio EL NUMERO INICIAL''   ) ;',
'    end if;',
'',
'if :P283_NRO_HASTA is null then',
'',
'     raise_application_error(-20001,''Es Obligatorio el NUMERO FINAL''   ) ;',
'    end if;',
'',
'if :P283_VENDEDOR is null then',
'   raise_application_error(-20001,''Es Obligatorio el VENDEDOR''   ) ;',
'    end if;',
''))
,p_attribute_02=>'P283_TIPO_VALE,P283_PROVEEDOR_VALE,P283_NRO_DESDE,P283_NRO_HASTA,P283_VENDEDOR'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608328838583040)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
,p_attribute_01=>'Esta Seguro de Asignar los Vales?'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608471014583041)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608566919583042)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'update fv_REGISTRO_vales_combustibles f',
'set f.fecha_entrega=trunc(sysdate), usuario_entrega=:P_COD_USUARIO, ESTADO=''S'', F.COD_VENDEDOR_DISTRIBUIDOR= :P283_VENDEDOR',
'WHERE F.COD_EMPRESA=:P_COD_EMPRESA',
'AND F.TIPO = :P283_TIPO_VALE',
'AND F.COD_PROVEEDOR = :P283_PROVEEDOR_VALE',
'AND NVL(F.ESTADO,''N'')=''N''',
'AND to_number(F.REG_ID) BETWEEN to_number(:P283_NRO_DESDE) AND to_number(:P283_NRO_HASTA);',
'COMMIT;',
'end;'))
,p_attribute_02=>'P283_TIPO_VALE,P283_PROVEEDOR_VALE,P283_NRO_DESDE,P283_NRO_HASTA,P283_VENDEDOR'
,p_attribute_05=>'PLSQL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608665998583043)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(390608764389583044)
,p_event_id=>wwv_flow_imp.id(390608274416583039)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(133810733383222838)
);
