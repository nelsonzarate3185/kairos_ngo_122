prompt --application/pages/page_00738
begin
--   Manifest
--     PAGE: 00738
--   Manifest End
...
,p_name=>'Pantalla_procedimiento'
,p_alias=>'PANTALLA-PROCEDIMIENTO'
,p_step_title=>'Pantalla_procedimiento'
...
,p_last_upd_yyyymmddhh24miss=>'20240919110733'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(422170534322298535)
...
,p_plug_source=>'<h1>Procedimientos</h1>'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(422170572876298536)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(565757444555220515)
,p_plug_name=>'Titulo'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(565757485535220515)
,p_name=>'Titulo'
...
,p_owner=>'VGAMARRA'
,p_internal_uid=>565757485535220515
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285293680696012512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285291636837012511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285292016485012512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285292872543012512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285293282243012512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285291268522012511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(285290856727012511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(286835336969879921)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(286837090718879938)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(557944921178594316)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(565762577024220905)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(285288536796012503)
,p_button_sequence=>15
,p_button_plug_id=>wwv_flow_imp.id(422170572876298536)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(286836583864879933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(285288905547012503)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(285289311667012503)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(285289770136012504)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(285296197551012521)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(565757444555220515)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(285296698705012523)
,p_event_id=>wwv_flow_imp.id(285296197551012521)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(565757444555220515)
);
