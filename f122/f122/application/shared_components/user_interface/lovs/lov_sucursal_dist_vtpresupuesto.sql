prompt --application/shared_components/user_interface/lovs/lov_sucursal_dist_vtpresupuesto
begin
--   Manifest
--     LOV_SUCURSAL_DIST_VTPRESUPUESTO
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(100849163661390976)
,p_lov_name=>'LOV_SUCURSAL_DIST_VTPRESUPUESTO'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(100849671576395461)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(100850028564395462)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(100851257625395462)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(100850423957395462)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(100850835972395462)
