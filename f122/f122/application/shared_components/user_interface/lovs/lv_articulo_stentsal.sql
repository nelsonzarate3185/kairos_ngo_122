prompt --application/shared_components/user_interface/lovs/lv_articulo_stentsal
begin
--   Manifest
--     LV_ARTICULO_STENTSAL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(154997359294296255)
,p_lov_name=>'LV_ARTICULO_STENTSAL'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154997602791296254)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154998053307296254)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154998413851296254)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154998865029296253)
