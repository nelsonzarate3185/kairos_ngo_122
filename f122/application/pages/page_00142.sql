...
,p_last_upd_yyyymmddhh24miss=>'20250321143112'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(234614297609633884)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(235558041109820159)
...
'AND   (NVL(:P142_ESTADO,''T'') =''T'' OR :P142_ESTADO=OT.ESTADO_PRESU)',
'AND   (NVL(:P142_CLIENTE,''T'')=''T'' OR :P142_CLIENTE=OT.COD_CLIENTE)',
'AND   ( :P142_PROVEEDOR is null OR :P142_PROVEEDOR=OT.COD_PROVEEDOR)',
'AND   ( :P142_NRO_OT is null OR :P142_NRO_OT=OT.NRO_COMPROBANTE)',
'AND   ( :P142_SER_OT is null OR :P142_SER_OT=OT.SER_COMPROBANTE) ',
'AND   ( :P142_ORIGEN is null OR :P142_ORIGEN=OT.COD_ORIGEN) ',
'AND   ( :P142_FECHA_INI is null OR OT.FEC_COMPROBANTE >= TO_DATE(:P142_FECHA_INI,''DD/MM/YYYY''))',
'AND   ( :P142_FECHA_FIN is null OR OT.FEC_COMPROBANTE <= TO_DATE(:P142_FECHA_FIN,''DD/MM/YYYY''))',
'and   ( :P142_PARAM_CLIENTE is null or :P142_PARAM_CLIENTE=ot.COD_CLIENTE)',
'',
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(235558402961820159)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:588:&SESSION.::&DEBUG.:RR,588:P588_SER_COMPROBANTE,P588_NRO_COMPROBANTE:#SER_COMPROBANTE#,#NRO_COMPROBANTE#'
,p_detail_link_text=>'<span aria-label="Editar"><span class="fa fa-search-plus" aria-hidden="true" title="Editar"></span></span>'
,p_owner=>'JUANSA'
,p_internal_uid=>235558402961820159
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30286920134775509)
,p_db_column_name=>'OT'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30287383262775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30287721059775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30288147526775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30293336446775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30293794031775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30294122833775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30294549604775513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30288586551775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30288961501775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30289391819775510)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30289705846775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30290112275775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30290532518775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30290927704775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30291356245775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30291725852775511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30292167466775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30292528759775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30292905824775512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30294902868775513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(30295374767775513)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(235568138644821904)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30296094267775514)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(235558041109820159)
...
,p_button_redirect_url=>'f?p=&APP_ID.:63:&SESSION.::&DEBUG.:CR,63::'
,p_button_css_classes=>'u-color-1-bg'
,p_icon_css_classes=>'fa fa-pencil'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30296789902775514)
,p_name=>'P142_PROVEEDOR'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30297127991775515)
,p_name=>'P142_PARAM_CLIENTE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30297513288775515)
,p_name=>'P142_CLIENTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_prompt=>'Cliente'
...
'and   nvl(cl.estado,'''')<>''I''',
'AND   ( :P142_PROVEEDOR is null OR :P142_PROVEEDOR=v.COD_PROVEEDOR)',
'and   ( :P142_PARAM_CLIENTE is null or :P142_PARAM_CLIENTE=v.COD_CLIENTE)',
'union all',
'',
'select ''TODOS'',''T''',
'FROM DUAL',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30297937447775516)
,p_name=>'P142_ESTADO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_prompt=>'Estado'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30298316625775516)
,p_name=>'P142_FECHA_INI'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30298748034775516)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30299146188775516)
,p_name=>'P142_ORIGEN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_prompt=>'Origen'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30299529658775517)
,p_name=>'P142_USER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_source=>'&APP_USER.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30299998886775517)
,p_name=>'P142_SER_OT'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30300303583775517)
,p_name=>'P142_NRO_OT'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(234614297609633884)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30300769434775517)
,p_name=>'CLIC_EST'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P142_ESTADO'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30301236700775518)
,p_event_id=>wwv_flow_imp.id(30300769434775517)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30301683642775518)
,p_name=>'CLIC_CL'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P142_CLIENTE'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30302197511775518)
,p_event_id=>wwv_flow_imp.id(30301683642775518)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30302523880775518)
,p_name=>'CHNG_FEC_INI'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P142_FECHA_INI'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30303008789775518)
,p_event_id=>wwv_flow_imp.id(30302523880775518)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30303408065775518)
,p_name=>'CHNG_FEC_FIN'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P142_FECHA_FIN'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30303917278775518)
,p_event_id=>wwv_flow_imp.id(30303408065775518)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30304349534775519)
,p_name=>'Sltd_origen'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P142_ORIGEN'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30304839564775519)
,p_event_id=>wwv_flow_imp.id(30304349534775519)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
