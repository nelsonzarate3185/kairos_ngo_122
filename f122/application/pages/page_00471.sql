...
,p_name=>'TUR - ticket_llamador_cliente'
,p_alias=>'TICKET-LLAMADOR_CLIENTE'
,p_step_title=>'Ticket llamador Cliente'
...
'    apex.item(''P471_REFRESCA_REGION'').setValue(1);',
'}',
'',
'function contador(){',
'	 apex.server.process(',
...
'                $x_Hide("ATTENDANCE");',
'                $x_Show("promociones");',
'                apex.item("P471_REPRODUCIR").setValue(0);',
'            }  ',
...
'                ',
'                apex.item("P471_NUMERO1").setValue(pData.p_num_ticket);',
'                apex.item("P471_LETRA").setValue(pData.p_serie_ticket);',
'                apex.item("P471_BOX").setValue(pData.p_box);',
'                apex.item("P471_ID_TICKET").setValue(pData.p_id_ticket);',
'                apex.item("P471_NUMERO_TICKET").setValue(pData.p_serie_ticket+pData.p_num_ticket);',
'                apex.item("P471_BOX_TICKET").setValue(''Box ''+pData.p_box);',
'',
'                apex.server.process(',
'                ''ACTUALIZA_HORA_LLAMADA'', ',
'                { x01: apex.item("P471_ID_TICKET").getValue()}, ',
'                {',
'                success: function (pData) { ',
'                    null;',
'                    ',
...
'                function myTimer8() {',
'                    apex.item("P471_REPRODUCIR").setValue(1);',
'                }     ',
'            }',
'            ',
'            }, ',
...
,p_last_upd_yyyymmddhh24miss=>'20230801105522'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137939628558472720)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137939498565472718)
,p_plug_name=>'Pronostico del Tiempo'
,p_parent_plug_id=>wwv_flow_imp.id(137939628558472720)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143657738287222701)
,p_plug_name=>'Pronostico'
,p_parent_plug_id=>wwv_flow_imp.id(137939498565472718)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40096829222263653)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137941403698472738)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139850097409908201)
,p_plug_name=>'Video 1'
,p_parent_plug_id=>wwv_flow_imp.id(137941403698472738)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139850117216908202)
,p_plug_name=>'Video 2'
,p_parent_plug_id=>wwv_flow_imp.id(137941403698472738)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139850286286908203)
,p_plug_name=>'Video 3'
,p_parent_plug_id=>wwv_flow_imp.id(137941403698472738)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40096829222263653)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(398477006628845720)
,p_plug_name=>'Ticket'
...
'<audio id="audio3" src="#WORKSPACE_FILES#&P471_LETRA..mp3"/>			',
'<audio id="audio4" src="#WORKSPACE_FILES#&P471_NUMERO1..mp3"/>',
'<audio id="audio5" src="#WORKSPACE_FILES#&P471_OPERACION..mp3"/>',
'<audio id="audio6" src="#WORKSPACE_FILES#&P471_BOX..mp3"/> ',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137939857950472722)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137939768701472721)
,p_plug_name=>'PROMEDIOS'
,p_parent_plug_id=>wwv_flow_imp.id(137939857950472722)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(137940334413472727)
,p_region_id=>wwv_flow_imp.id(137939768701472721)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137940566960472729)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(139854597149908246)
,p_plug_name=>'ATENDIDOS'
,p_parent_plug_id=>wwv_flow_imp.id(137940566960472729)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(139854696909908247)
,p_region_id=>wwv_flow_imp.id(139854597149908246)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137941323808472737)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(137941237019472736)
,p_plug_name=>'LLAMADOS'
,p_region_name=>'llamados'
,p_parent_plug_id=>wwv_flow_imp.id(137941323808472737)
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleC'
,p_plug_template=>wwv_flow_imp.id(40100032401263654)
,p_plug_display_sequence=>90
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(139850382730908204)
,p_region_id=>wwv_flow_imp.id(137941237019472736)
,p_layout_type=>'GRID'
,p_grid_column_count=>2
,p_title_adv_formatting=>false
,p_title_column_name=>'TICKET'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(144106224693741301)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(143657832543222702)
,p_plug_name=>'EN ESPERA'
,p_parent_plug_id=>wwv_flow_imp.id(144106224693741301)
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40100032401263654)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(143657982289222703)
,p_region_id=>wwv_flow_imp.id(143657832543222702)
,p_layout_type=>'GRID'
,p_grid_column_count=>2
,p_title_adv_formatting=>false
,p_title_column_name=>'TICKET'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(144433563791136201)
,p_plug_name=>'horas'
,p_parent_plug_id=>wwv_flow_imp.id(137939857950472722)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40096829222263653)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(138872921918677713)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(137941774966472741)
,p_name=>'P471_REPRODUCIR'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138862878591677721)
,p_name=>'P471_TICKET'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138863290533677720)
,p_name=>'P471_NUMERO1'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138863671509677720)
,p_name=>'P471_NUMERO_TICKET'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138864018747677719)
,p_name=>'P471_LETRA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138864439085677719)
,p_name=>'P471_BOX'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138864867272677719)
,p_name=>'P471_BOX_TICKET'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138865215714677719)
,p_name=>'P471_HORA'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(144433563791136201)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(138865684526677719)
,p_name=>'P471_NUMERO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(139852892294908229)
,p_name=>'P471_ID_TICKET'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(143063678509595109)
,p_name=>'P471_REFRESCA_REGION'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(152756487840015805)
,p_name=>'P471_OPERACION'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(398477006628845720)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137942243772472746)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137941535510472739)
,p_event_id=>wwv_flow_imp.id(137942243772472746)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137942423518472748)
,p_event_id=>wwv_flow_imp.id(137942243772472746)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139854945910908250)
,p_event_id=>wwv_flow_imp.id(137942243772472746)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138866791904677717)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138867724216677716)
,p_event_id=>wwv_flow_imp.id(138866791904677717)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    if (apex.item("P471_NUMERO1").isEmpty()) {',
'        $x_Hide("ATTENDANCE");',
'        $x_Show("promociones");',
'        apex.item( "P471_NUMERO_TICKET" ).setFocus();',
'    } else {  ',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137941867409472742)
,p_name=>'Reproducir ticket'
,p_event_sequence=>120
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P471_REPRODUCIR'
,p_condition_element=>'P471_REPRODUCIR'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137942096997472744)
,p_event_id=>wwv_flow_imp.id(137941867409472742)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143063448594595107)
,p_event_id=>wwv_flow_imp.id(137941867409472742)
...
,p_affected_region_id=>wwv_flow_imp.id(137941237019472736)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143062918366595102)
,p_event_id=>wwv_flow_imp.id(137941867409472742)
,p_event_result=>'TRUE'
...
,p_affected_elements=>'P471_REPRODUCIR'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143063595560595108)
,p_event_id=>wwv_flow_imp.id(137941867409472742)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(139854597149908246)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(143063125269595104)
,p_name=>'Refresca llamadores'
,p_event_sequence=>130
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P471_REFRESCA_REGION'
,p_condition_element=>'P471_REFRESCA_REGION'
,p_triggering_condition_type=>'EQUALS'
,p_triggering_expression=>'1'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139850454932908205)
,p_event_id=>wwv_flow_imp.id(143063125269595104)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143062842592595101)
,p_event_id=>wwv_flow_imp.id(143063125269595104)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(144106306500741302)
,p_event_id=>wwv_flow_imp.id(143063125269595104)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(143657832543222702)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143063037537595103)
,p_event_id=>wwv_flow_imp.id(143063125269595104)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P471_REFRESCA_REGION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137939353797472717)
...
'        into vnumero, :P471_BOX, :P471_LETRA, :P471_ID_TICKET',
...
'        :P471_NUMERO1:=null;',
'        :P471_BOX_TICKET:= null;',
'        :P471_NUMERO_TICKET:=null;',
'        :P471_ID_TICKET :=  NULL;',
'    else ',
'        :P471_NUMERO1:= vnumero;--vnumero;',
'        :P471_LETRA  := :P471_LETRA;',
'        :P471_TICKET:=''TICKET'';',
'        :P471_BOX  :=  :P471_BOX;',
'        :P471_NUMERO_TICKET:= :P471_LETRA||:P471_NUMERO1;',
'        :P471_BOX_TICKET:= ''Box ''||:P471_BOX;',
'    end if;',
'end;',
''))
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137942132952472745)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137942564564472749)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137942676513472750)
