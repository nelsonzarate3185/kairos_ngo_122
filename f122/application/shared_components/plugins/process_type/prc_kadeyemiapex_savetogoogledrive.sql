...
begin
--   Manifest
--     PLUGIN: PRC.KADEYEMIAPEX.SAVETOGOOGLEDRIVE
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(128790356238311286)
...
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('PROCESS TYPE','PRC.KADEYEMIAPEX.SAVETOGOOGLEDRIVE'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128790818429367253)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128791111485371095)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128791424192373696)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128791712727377241)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128791978133386396)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128792286501388461)
,p_plugin_attribute_id=>wwv_flow_imp.id(128791978133386396)
,p_display_sequence=>10
,p_display_value=>'writer'
,p_return_value=>'writer'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128792755924393651)
,p_plugin_attribute_id=>wwv_flow_imp.id(128791978133386396)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128793105019394911)
,p_plugin_attribute_id=>wwv_flow_imp.id(128791978133386396)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128793847810403094)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128794103182408345)
,p_plugin_attribute_id=>wwv_flow_imp.id(128793847810403094)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128794504826410230)
,p_plugin_attribute_id=>wwv_flow_imp.id(128793847810403094)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128794909190411712)
,p_plugin_attribute_id=>wwv_flow_imp.id(128793847810403094)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(128795331614416301)
,p_plugin_attribute_id=>wwv_flow_imp.id(128793847810403094)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128795920834424898)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128796256086433238)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128796538416437670)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(128796807828447873)
,p_plugin_id=>wwv_flow_imp.id(128790356238311286)
,p_attribute_scope=>'COMPONENT'
