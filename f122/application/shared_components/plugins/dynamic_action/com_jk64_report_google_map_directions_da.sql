...
begin
--   Manifest
--     PLUGIN: COM.JK64.REPORT_GOOGLE_MAP_DIRECTIONS_DA
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1893555065168245432)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'COM.JK64.REPORT_GOOGLE_MAP_DIRECTIONS_DA'
,p_display_name=>'JK64 Report Google Map R1 Show Directions'
,p_category=>'EXECUTE'
,p_supported_ui_types=>'DESKTOP'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('DYNAMIC ACTION','COM.JK64.REPORT_GOOGLE_MAP_DIRECTIONS_DA'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893562696100245384)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1893563603334245383)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893562696100245384)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1893564107723245382)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893562696100245384)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1893564548476245382)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893562696100245384)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1893565051769245382)
,p_plugin_attribute_id=>wwv_flow_imp.id(1893562696100245384)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893565531679245382)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1893562696100245384)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893565956228245382)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893566322602245381)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893566777647245381)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893596914323191002)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893597247121184009)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893597581218182211)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893597852797178720)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893599853330094492)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893600182054091561)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893600502546089486)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1893600772652087141)
,p_plugin_id=>wwv_flow_imp.id(1893555065168245432)
,p_attribute_scope=>'COMPONENT'
