prompt --application/shared_components/user_interface/lovs/lv_linea_camostam
begin
--   Manifest
--     LV_LINEA_CAMOSTAM
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(148636118071053414)
,p_lov_name=>'LV_LINEA_CAMOSTAM'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT DISTINCT NVL(L.DESCRIPCION,''Ninguna'') D,',
'        V.COD_ARTICULO R',
'        FROM ST_ARTICULOS S,',
'             st_linea l,',
'             st_categorias c,',
