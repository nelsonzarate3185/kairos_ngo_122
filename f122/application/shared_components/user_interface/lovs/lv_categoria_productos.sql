prompt --application/shared_components/user_interface/lovs/lv_categoria_productos
begin
--   Manifest
--     LV_CATEGORIA_PRODUCTOS
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(78396020501063196)
,p_lov_name=>'LV_CATEGORIA_PRODUCTOS'
