prompt --application/shared_components/user_interface/lovs/lv_articulo_corto_stentsal
begin
--   Manifest
--     LV_ARTICULO_CORTO_STENTSAL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(154982849274320431)
,p_lov_name=>'LV_ARTICULO_CORTO_STENTSAL'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154993135595302909)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154993536593302909)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154993998163302909)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(154994311322302909)
