prompt --application/shared_components/user_interface/lovs/lv_cx_referencia_canal
begin
--   Manifest
--     LV_CX_REFERENCIA_CANAL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(981880448268482037)
,p_lov_name=>'LV_CX_REFERENCIA_CANAL'
