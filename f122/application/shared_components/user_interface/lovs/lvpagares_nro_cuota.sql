prompt --application/shared_components/user_interface/lovs/lvpagares_nro_cuota
begin
--   Manifest
--     LVPAGARES_NRO_CUOTA
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(116167154492657646)
,p_lov_name=>'LVPAGARES_NRO_CUOTA'
...
,p_return_column_name=>'NRO_CUOTA'
,p_display_column_name=>'NRO_CUOTA'
