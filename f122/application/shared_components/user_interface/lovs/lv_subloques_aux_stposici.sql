prompt --application/shared_components/user_interface/lovs/lv_subloques_aux_stposici
begin
--   Manifest
--     LV_SUBLOQUES_AUX_STPOSICI
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(236046641475991008)
,p_lov_name=>'LV_SUBLOQUES_AUX_STPOSICI'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(236047288255994324)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(236047629240994324)
