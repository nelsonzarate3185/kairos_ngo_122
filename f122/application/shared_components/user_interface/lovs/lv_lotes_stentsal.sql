prompt --application/shared_components/user_interface/lovs/lv_lotes_stentsal
begin
--   Manifest
--     LV_LOTES_STENTSAL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(156502954541233579)
,p_lov_name=>'LV_LOTES_STENTSAL'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(156505623445223611)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(156505932006223610)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(156506398974223610)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(156506703210223610)
