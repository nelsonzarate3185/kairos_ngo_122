prompt --application/shared_components/user_interface/lovs/lv_articulos_stocons
begin
--   Manifest
--     LV_ARTICULOS_STOCONS
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(209744063968225946)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(209744434495225946)
