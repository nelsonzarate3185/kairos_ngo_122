prompt --application/shared_components/user_interface/lovs/lov_clientes_atcpv
begin
--   Manifest
--     LOV_CLIENTES_ATCPV
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(878017356166145777)
,p_lov_name=>'LOV_CLIENTES_ATCPV'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(878019359509155011)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(878019774986155011)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(878020131378155011)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(878020517414155011)
