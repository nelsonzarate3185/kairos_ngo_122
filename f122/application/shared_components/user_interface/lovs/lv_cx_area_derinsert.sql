prompt --application/shared_components/user_interface/lovs/lv_cx_area_derinsert
begin
--   Manifest
--     LV_CX_AREA_DERINSERT
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1049393001420921573)
,p_lov_name=>'LV_CX_AREA_DERINSERT'
